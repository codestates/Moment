...
const WriteLog = ({login, loginHandler}) => {
        ...
        <form className={classes.formContainer} onSubmit={submitHandler}>
            ...
            <div className={classes.secret}>
                ...
                <label id="secret" htmlFor="secret">
                    {!secret && <div className={classes.lockContainer}><AiFillUnlock  size="24"/><span className={classes.lockImg}>Keep Your Precious Moment to Yourself</span></div>}
                    {secret && <div className={classes.lockContainer}><AiFillLock size="24"/><span className={classes.unlockImg}>Share your Moment with Others</span></div>}
                </label>
            </div>
